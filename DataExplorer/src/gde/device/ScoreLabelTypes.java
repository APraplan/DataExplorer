...
public enum ScoreLabelTypes {
	...
	/**
	 * Scores with raw values, e.g. bits, tokens.
	 */
	public static final EnumSet<ScoreLabelTypes>	RAW_TYPES	= EnumSet.noneOf(ScoreLabelTypes.class);
	/**
	 * Scores with raw values, e.g. bits, tokens.
	 */
	public static final EnumSet<ScoreLabelTypes>	ODD_RANGE_TYPES	= EnumSet.noneOf(ScoreLabelTypes.class);

	static {
		RAW_TYPES.add(SENSORS);
		ODD_RANGE_TYPES.add(SIGMA_TIME_STEP_MS);
		ODD_RANGE_TYPES.add(LOST_PACKAGES_SIGMA_MS);
	}
    ...
    public boolean isRaw() {
    	return RAW_TYPES.contains(this);
    }
