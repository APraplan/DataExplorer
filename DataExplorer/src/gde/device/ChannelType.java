...
public class ChannelType {
	...
	public List<MeasurementType> getMeasurement() {
		...
		if (!isWithMeasurementIds) {
			// todo remove this after replacing the ordinal number with measurementId in the device.xml
			measurement = new ArrayList<MeasurementType>(measurement) {
				private static final long serialVersionUID = 7963660916422067131L;

				@Override
				public boolean add(MeasurementType e) {
					isWithMeasurementIds = false;
					return super.add(e);
				}
			...
			for (int i = 0; i < measurement.size(); i++) {
				MeasurementType measurementType = measurement.get(i);
				measurementType.measurementId = i; // todo clean solution required : Id to define in the xml
			}
			isWithMeasurementIds = true;
		}
