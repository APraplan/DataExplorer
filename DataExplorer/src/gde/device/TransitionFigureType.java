...
public class TransitionFigureType {
    ...
    public void setComment(String value) {
  	...
  	public String toString() {
  		...
  		sb.append("transitionGroupId=").append(this.getTransitionGroupId()).append(GDE.STRING_COMMA_BLANK).append("figureType=").append(this.getFigureType().value()).append(GDE.STRING_COMMA_BLANK); //$NON-NLS-1$ //$NON-NLS-2$
  		return sb.toString();
  	}
